...
const uint16_t PROGMEM osm_lshift_combo[] = {LSFT_T(KC_R), RSFT_T(KC_I), COMBO_END};
const uint16_t PROGMEM osm_lctrl_combo[] = {LCTL_T(KC_A), RCTL_T(KC_O), COMBO_END};

const uint16_t PROGMEM osm_gui_combo[] = {LT(2,KC_L), KC_N, COMBO_END};

const uint16_t PROGMEM osm_alt_combo[] = {LT(2,KC_P), KC_T, COMBO_END};
...
const uint16_t PROGMEM osm_num_combo[] = {KC_F, LT(2,KC_P), COMBO_END};
const uint16_t PROGMEM osm_rnum_combo[] = {LT(2,KC_L), KC_U, COMBO_END};

const uint16_t PROGMEM num_on_combo[] = {KC_F, LT(2,KC_P), LT(2,KC_L), KC_U, COMBO_END};
const uint16_t PROGMEM num_on_1_combo[] = {KC_HASH, KC_DLR, KC_AMPR, KC_ASTR, COMBO_END};
const uint16_t PROGMEM num_on_2_combo[] = {KC_UP, KC_TRNS, KC_7, LT(4,KC_8), COMBO_END};
...
const uint16_t PROGMEM l2_on_to_l1_combo[] = {KC_F, LT(2,KC_P), COMBO_END};

const uint16_t PROGMEM default_layer_1_on_combo[] = {KC_LCBR, KC_RCBR, COMBO_END};
const uint16_t PROGMEM default_layer_2_on_combo[] = {KC_LEFT, RSFT_T(KC_6), COMBO_END};
...
combo_t key_combos[] = {
    ...
    COMBO(num_on_2_combo, TO(2)),
};

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
		    TO(0), TO(0), OSL(2), TO(1), TO(2), KC_CAPS, 			 			TO(5), CW_TOGG, OSL(1), OSM(MOD_LSFT), TO(0), KC_BSPC,

		    KC_TAB, KC_Q, KC_W, KC_F, LT(2,KC_P), KC_G, 						KC_J, LT(2,KC_L), KC_U, KC_Y, KC_SCLN, KC_MINS,

		    TO(0), LCTL_T(KC_A), LSFT_T(KC_R), KC_S, KC_T, KC_D,		 			KC_H, KC_N, 	  KC_E, RSFT_T(KC_I), RCTL_T(KC_O), KC_QUOT,
    ...
    [2] = LAYOUT(
		   ...
		   KC_NO, KC_ESC, KC_NO, KC_UP, KC_TRNS, KC_NO,						 	KC_NO, KC_7, LT(4,KC_8), KC_9, KC_0, KC_NO, 
		   TO(0), KC_SPC, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, 						KC_TRNS, RGUI_T(KC_4), RALT_T(KC_5), RSFT_T(KC_6), RCTL_T(KC_0),
    ...
    [3] = LAYOUT(
		    ...
		    KC_NO, KC_BTN1, KC_BTN1, KC_MS_U, KC_BTN2, KC_NO,				 KC_NO, KC_BTN1, KC_WH_U, KC_BTN2, KC_NO, KC_NO,
		    TO(0), KC_NO, KC_MS_L, KC_MS_D, KC_MS_R, KC_NO,				 KC_NO, KC_WH_L, KC_WH_D, KC_WH_R, KC_NO, KC_NO,
		    KC_NO, KC_NO, KC_ACL0, KC_ACL1, KC_ACL2, KC_PSCR, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, TO(0), KC_TRNS, KC_TRNS, KC_TRNS, NK_TOGG, QK_BOOT),

    [4] = LAYOUT(TO(0), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_BSPC, KC_NO, TO(1), TO(2), TO(3), TO(2), KC_CAPS, KC_NO, TG(2), CW_TOGG, TO(2), TO(1), KC_NO, TO(0), KC_LCTL, KC_LSFT, KC_LALT, KC_LGUI, KC_NO, KC_NO, KC_DEL, KC_RALT, KC_RSFT, KC_RCTL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, TO(0), KC_SPC, KC_ENT, KC_NO, NK_TOGG, KC_NO),

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
		    ...
		    KC_ESC, KC_A, LSFT_T(KC_R), LT(2, KC_S), LSFT_T(KC_T), KC_D,	               KC_H, LSFT_T(KC_N), LT(2, KC_E), LSFT_T(KC_I), KC_O, KC_ENT,
    ...
    [2] = LAYOUT(
		   ...
		   QMK_BASE_LAYER, KC_NO, KC_NO, KC_NO, KC_SPC, KC_SPC, KC_LT,				 KC_GT, KC_ENT, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_NO,

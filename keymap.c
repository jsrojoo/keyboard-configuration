...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
		    ...
		    KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5,                               KC_6, KC_7, OSM(MOD_LALT), OSM(MOD_LGUI), KC_0, KC_ESC,

		    KC_TAB, KC_Q, KC_W, KC_F, KC_P, KC_G,                               KC_J, KC_L, KC_U, KC_Y, KC_SCLN, KC_BSPC,

		    TD(TD_BASE_ESC), KC_A, KC_R, KC_S, KC_T, KC_D,	                    KC_H, KC_N, KC_E, KC_I, KC_O, KC_QUOT,

		    KC_NO, OSM(MOD_LSFT), LT(2, KC_X), KC_C, KC_V, KC_B, KC_LT,	    KC_GT,	KC_K, KC_M, KC_COMM, LT(2, KC_DOT), OSM(MOD_LSFT), KC_NO,

		    					TO(5), TO(3), OSL(1), KC_SPC,		            KC_ENT, OSL(1), TO(5), TO(3)
		    ),

    [1] = LAYOUT(
		   KC_GRV, KC_1, KC_2, KC_2, KC_4, KC_5,                          KC_6, KC_7, KC_8, KC_9, KC_0, KC_ESC,
    ...
    [2] = LAYOUT(
		   ...
		   KC_NO, KC_F11, KC_F12, KC_UP, KC_SPC, KC_NO,						            KC_J, KC_7, KC_8, KC_9, KC_SCLN, KC_BSPC,

		   TD(TD_BASE_ESC), KC_ENT, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, 				    KC_H, KC_4, KC_5, KC_6, KC_0, KC_QUOT,

		   KC_NO, KC_Z, KC_NO, KC_NO, KC_SPC, KC_NO, KC_LT,				    KC_GT,	KC_K, KC_1, KC_2, KC_3, OSM(MOD_LSFT), KC_NO,

		    					LT(5,KC_PSCR), TO(3), QK_LLCK, KC_SPC,		 KC_ENT, QK_LLCK, TO(5), TO(3)
		   ),

    [3] = LAYOUT(
		    KC_GRV, KC_VOLD, KC_VOLU, KC_BRID, KC_BRIU, QK_BOOT,		         KC_NO, KC_NO, OSM(MOD_LGUI), OSM(MOD_LALT), KC_NO, KC_ESC,

		    KC_NO, KC_BTN1, KC_BTN1, KC_MS_U, KC_BTN2, KC_NO,				 		     KC_NO, KC_BTN1, KC_WH_U, KC_BTN2, KC_BTN1, KC_DEL,

		    TD(TD_BASE_ESC), KC_NO, KC_MS_L, KC_MS_D, KC_MS_R, KC_NO,				 KC_NO, KC_WH_L, KC_WH_D, KC_WH_R, KC_NO, KC_NO,

		    KC_NO, DT_UP, DT_DOWN, DT_PRNT, KC_NO, KC_PSCR, KC_NO,		 		 KC_NO, KC_NO, OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LSFT), OSM(MOD_LCTL), KC_NO,
    ...
    [5] = LAYOUT(
		    ...
		    KC_GRV, KC_NO, KC_DQUO, KC_QUOT, TO(2), KC_NO,		                    KC_NO, TO(5), OSM(MOD_LALT), OSM(MOD_LGUI), KC_NO, KC_ESC,

		    KC_TAB, KC_Q, KC_W, KC_F, KC_P, KC_G,							        KC_J, KC_7, KC_8, KC_9, KC_SCLN, KC_DEL,
